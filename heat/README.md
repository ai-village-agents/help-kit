...
2. [What is Inside the Kit](#-what-is-inside-the-kit)
3. [Emergency Protocol: Heat Exhaustion vs. Heat Stroke](#-emergency-protocol-heat-exhaustion-vs-heat-stroke)
4. [Buddy-Check Checklist Guide](#-buddy-check-checklist-guide)
5. [How to Launch a Neighbor Buddy-Check Network (under 2 hours)](#-how-to-launch-a-neighbor-buddy-check-network-under-2-hours)
6. [Science-Backed Sourcing & Citations](#-science-backed-sourcing--citations)
...
This toolkit consists of highly actionable, print-friendly, and lightweight digital assets:
* **[Welfare Buddy-Check Sheet](templates/buddy-check-sheet.md):** A simple, checklist-based template for volunteers to track household status during welfare visits.
* **[Heat Safety One-Pager](flyer/heat-safety-flyer.md):** A high-contrast, easily printable community flyer with critical safety guidelines and emergency contacts.
* **[Evidence-Based Cooling Guide](protocols/cooling-guide.md):** Medical and operational guidelines on active cooling, hydration, and home cooling workarounds.
* **[Mobile-Friendly Portal](index.html):** An offline-first, fast-loading web app for lookups on mobile phones under poor network conditions.

---

## ⚕️ Emergency Protocol: Heat Exhaustion vs. Heat Stroke

It is critical to distinguish between Heat Exhaustion and Heat Stroke. **Heat Stroke is a life-threatening medical emergency.**

| Symptom / Sign | Heat Exhaustion 🌡️ | Heat Stroke 🚨 (EMERGENCY) |
| :--- | :--- | :--- |
| **Body Temp** | Usually under 103°F (39.4°C) | **Over 103°F (39.4°C)** |
| **Skin State** | Cool, pale, clammy, heavy sweating | **Hot, red, dry OR damp (no sweating)** |
...
## 🤝 Buddy-Check Checklist Guide
When performing door-to-door welfare checks, ask these three key screening questions:
1. **Physical Well-being:** *"Are you feeling dizzy, nauseated, or unusually fatigued?"*
...
## 🚀 How to Launch a Neighbor Buddy-Check Network (under 2 hours)
1. **Identify Your Boundary:** Choose a block, an apartment building, or a specific neighborhood segment.
...
## 📚 Science-Backed Sourcing & Citations
All recommendations in this toolkit are drawn from leading public health and meteorological authorities:
* **Centers for Disease Control and Prevention (CDC):** [Extreme Heat Prevention Guide](https://www.cdc.gov/extreme-heat/prevention/)
